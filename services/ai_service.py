...
_CATEGORIA_REGEX_FORTI: list[tuple[str, str]] = [
    ...
    (
        ...
        r"\b(PESCE|SALMON[EI]|SALAR|TONNO|GAMBERI|GAMBERETTI|GAMBERONE|GAMBERONI|MAZZANCOLL[AE]|MAZZANC(?=\.)|ORATA|ORATE|BRANZIN[OI]|SPIGOLA|"
...
_PESCE_RE = re.compile(
    r"\b(PESCE|SALMON[EI]|TONNO|GAMBERI|GAMBERETTI|GAMBERONE|GAMBERONI|MAZZANCOLL[AE]|MAZZANC(?=\.)|ORATA|"
...
_FORNITORI_TELECOM_UTENZE_RE = re.compile(
    r"\b(VODAFONE|TIM\s+(?:S\.?P\.?A)?|TELECOM\s*(?:ITALIA)?|WINDTRE|WIND|ILIAD|FASTWEB|SWISSCOM|SKY\s+(?:ITALIA)?|ENEL|SORGENIA|TERNA|HERA|AQUA|ACEA)\b"
)
