...
| **2c** | **Il frontend: l'ultima zona rossa** — 4.069 righe | Lavoro tecnico | **E' l'unico rosso rimasto**: il backend e' chiuso al 100%. Prompt pronto: [`docs/piani/PROMPT_FRONTEND_ULTIMA_ZONA_ROSSA.md`](../docs/piani/PROMPT_FRONTEND_ULTIMA_ZONA_ROSSA.md). Da `(app)/agenda/` (694): era stata scartata con la misura «0 turni a DB», ma il 5/09 sera ha **107 turni, 4 dipendenti e dati caricati oggi** — e campi economici che entrano nel costo del personale, quindi nel MOL. **La premessa che l'aveva esclusa e' scaduta** |
