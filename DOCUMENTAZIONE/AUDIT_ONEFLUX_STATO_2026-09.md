...
| **2b** | **I 15 moduli `services/` ancora rossi** — 5.147 righe | Lavoro tecnico | **L'ultima zona mai guardata del backend.** Prompt pronto: [`docs/piani/PROMPT_15_MODULI_SERVICES_ROSSI.md`](../docs/piani/PROMPT_15_MODULI_SERVICES_ROSSI.md). Da `documenti_service` (1.096 righe, 3.542 documenti, regge lo scadenziario da 4,4 M€) e `tag_suggestion_service` (1.087, tocca la regola #1). Misurato il 05/09: **tutte le aree hanno dati veri**, nessuna è vuota |
