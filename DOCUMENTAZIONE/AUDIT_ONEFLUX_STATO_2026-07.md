...
2. **AI** (5/7, riga 4, agente Fable) — 2 HIGH + 4 MED + 4 LOW dichiarati
   ...
   AI) fra le tre, mai più riaperta in due mesi. **Prossima in ordine.**
...
Ordine consigliato: fatto Edge Functions, ora AI, poi Qualità/UI. Ognuna
riscrive la propria riga con data/esito reale al posto di quella attuale, non
aggiunge una riga parallela. **Lezione confermata di nuovo (7/7)**: la regola
"code-reviewer trova sempre un difetto reale" ha retto anche qui — un residuo
sul confine Edge Function↔worker che l'audit originale non aveva completamente
chiuso.
