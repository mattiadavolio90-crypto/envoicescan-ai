...
Verbale in `DOCUMENTAZIONE/AUDIT_ONEFLUX_STATO_2026-08_STORICO.md`, e aggiorna la
voce 9 in cima a `AUDIT_ONEFLUX_STATO_2026-08.md`.

Quando anche questo è chiuso **il ciclo 2026-08 non ha più nulla di aperto**:
sposta i due doc in `docs/storico/` e apri `AUDIT_ONEFLUX_STATO_<nuova data>.md`.
Era il punto 5 di F7, rinviato di proposito perché archiviare prima avrebbe reso
invisibili le 9 decisioni.
