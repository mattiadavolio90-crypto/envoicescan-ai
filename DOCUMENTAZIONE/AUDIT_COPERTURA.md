...
|---|---|---|---|
| **prossima** | L9 — Giornata del cliente e parità `/m` | account nuovo percorso in ordine cliente; stati vuoti, CTA morte, coppie desktop/mobile | Fable normale |
