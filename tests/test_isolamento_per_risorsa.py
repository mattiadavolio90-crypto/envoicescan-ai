...
def scenario(db_sql, worker, monkeypatch) -> Scenario:
    ...
    # gruppo_tags e gruppo_tag_prodotti hanno l'id IDENTITY (dal 15/09 anche nello
    # snapshot): i seed sotto inseriscono id espliciti piccoli, e l'upsert di
    # /api/gruppo/tag/{id}/prodotti genera il suo dalla sequenza — che va
    # spostata oltre i seed, o collide con loro.
