...
--
-- Allineato a mano anche il 15/09/2026 (lente L5, stessa ragione: niente
-- SUPABASE_DB_URL): `GENERATED BY DEFAULT AS IDENTITY` su gruppo_tags.id e
-- gruppo_tag_prodotti.id (lo script lo emette da oggi, attidentity), e le 4
-- colonne che lo snapshot dell'08/09 non aveva — fatture.oscurata, fatture.oscurata_at,
-- ristoranti.tipo_attivita, users.vista_fatture — misurate su
-- information_schema.columns, non dedotte dalle migration.
...
CREATE TABLE IF NOT EXISTS public.fatture (
    ...
    oscurata boolean DEFAULT false NOT NULL,
    oscurata_at timestamp with time zone
);
...
CREATE TABLE IF NOT EXISTS public.ristoranti (
    ...
    tipo_attivita text DEFAULT 'ristorazione'::text NOT NULL
);
...
CREATE TABLE IF NOT EXISTS public.users (
    ...
    nome_gruppo text,
    vista_fatture text DEFAULT 'agenda'::text NOT NULL
);
