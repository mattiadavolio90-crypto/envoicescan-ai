...
GRANT EXECUTE ON FUNCTION public._riparto_categoria_is_fb(p_categoria text) TO anon;
GRANT EXECUTE ON FUNCTION public._riparto_categoria_is_fb(p_categoria text) TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.articoli_da_fatture(p_user_id uuid, p_ristorante_id uuid, p_categorie_escluse text[]) TO anon;
GRANT EXECUTE ON FUNCTION public.articoli_da_fatture(p_user_id uuid, p_ristorante_id uuid, p_categorie_escluse text[]) TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.get_next_ordine_ricetta(p_user_id uuid, p_ristorante_id uuid) TO anon;
GRANT EXECUTE ON FUNCTION public.get_next_ordine_ricetta(p_user_id uuid, p_ristorante_id uuid) TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.gruppo_tag_analisi(p_ristorante_ids uuid[], p_descrizione_keys text[], p_data_da date, p_data_a date) TO anon;
GRANT EXECUTE ON FUNCTION public.gruppo_tag_analisi(p_ristorante_ids uuid[], p_descrizione_keys text[], p_data_da date, p_data_a date) TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.normalize_custom_tag_key(input_text text) TO anon;
GRANT EXECUTE ON FUNCTION public.normalize_custom_tag_key(input_text text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.normalize_custom_tag_key(input_text text) TO service_role;
GRANT EXECUTE ON FUNCTION public.normalizza_indirizzo_match(p_raw text) TO anon;
GRANT EXECUTE ON FUNCTION public.normalizza_indirizzo_match(p_raw text) TO authenticated;
