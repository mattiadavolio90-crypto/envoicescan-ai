...
function TotalCell({
  ...
  return (
    <td className="sticky right-0 z-10 bg-[color-mix(in_oklab,var(--color-sky-500)16%,var(--color-card))] text-right px-3 py-2 tabular-nums border-l-2 border-r border-sky-500/50 align-middle">
