...
// Proxy GET usato dal retry client-side (BlockRetry): se al primo render server
// il briefing torna vuoto per un cold-start del worker, il client ripinga qui e,
// appena il worker risponde, fa router.refresh() per ri-renderizzare il blocco.
// Nessun timeout corto qui: vogliamo aspettare che il worker si svegli.
