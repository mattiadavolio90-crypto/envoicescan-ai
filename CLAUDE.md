...
| Worker API | `services/fastapi_worker.py` (10.035 righe, `wc -l` 26/09/2026) | FastAPI — `/health`, `/api/*`; logica nei router `services/routers/*.py` |
