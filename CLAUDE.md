...
| Test | `tests/*.py` | **14.274 verdi + 45 skip** il 14/09/2026 — il totale **si muove coi file `.md`** (`test_documentazione_onesta` è parametrizzato su quelli), e da `tests/` sono 9 in meno che dalla root. **522 su un Postgres vero** (`-m sql`, di cui 314 dell'isolamento fra clienti) + 101 Deno. Frontend: nessun runner npm — vedi Trappole |
