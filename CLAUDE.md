...
| Test | `tests/*.py` | **14.319 verdi + 45 skip** il 15/09/2026 — il totale **si muove coi file `.md`** (`test_documentazione_onesta` è parametrizzato su quelli), e da `tests/` sono 9 in meno che dalla root. **538 su un Postgres vero** (`-m sql`, di cui 315 dell'isolamento fra clienti) + 101 Deno. Frontend: nessun runner npm — vedi Trappole |
