...
Genera o aggiorna `docs/piani/PIANO_<feature>.md` (formato: WORKFLOW.md §2)
...
- **Fasi**: checklist con quelle chiuse spuntate `[x]` e quelle aperte `[ ]`,
  ciascuna con il **modello consigliato** per eseguirla (WORKFLOW.md §3:
...
un secondo per la stessa feature (WORKFLOW.md §2: uno per feature).

Se il lavoro sta in una sessione sola o poche fasi già completate, dillo
esplicitamente invece di forzare un file: WORKFLOW.md §1 sconsiglia di
