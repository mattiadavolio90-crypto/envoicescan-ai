...
<p style='margin: 0; color: #014361; font-size: clamp(0.75rem, 1.8vw, 0.875rem); line-height: 1.4; word-wrap: break-word;'>💡 Puoi inserire per tutti i mesi un importo fisso per il costo del personale e per i costi F&B e spese generali (non inseriti attraverso le fatture caricate)</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("⚡ **Compilazione Rapida** - Applica lo stesso valore a tutti i 12 mesi")
